        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    getInfo = function (i) { return $($('.divided-row').find('.large-strong').get(i)); };
                    age = Number(getInfo(1).text()) || undefined;
                    country = {
                        name: getInfo(2).text(),
                        code: E.popSlashSource($('.image-and-label .flag')).split('.')[0]
                    };
                    ...
                    getStats = function (i) { return $($($('.stats-row').get(i)).find('span').get(1)).text(); };
                    statistics = {
                        kills: getStats(0),
